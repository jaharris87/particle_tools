function [ncycle,u_c,r,pqpv,flat_r,lum] = import_modelsn_segment(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [U_C,R,PQPV,FLAT_R,LUM] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the default selection.
%
%   [U_C,R,PQPV,FLAT_R,LUM] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [u_c,r,pqpv,flat_r,lum] = importfile('modelsn_0126502.d',2, 721);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/03/26 17:29:52
