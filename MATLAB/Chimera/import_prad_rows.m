function prad_rows = import_prad_rows(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   N_PART_X = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the default selection.
%
%   N_PART_X = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   n_part_x = importfile('pinput_file',2, 119);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/08/10 18:33:50
