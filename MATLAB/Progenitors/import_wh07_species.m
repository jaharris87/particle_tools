function [wh07_nname,wh07_zz,wh07_aa] = import_wh07_species(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [WH07_NNAME,WH07_ZZ,WH07_AA] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the default selection.
%
%   [WH07_NNAME,WH07_ZZ,WH07_AA] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [wh07_nname,wh07_zz,wh07_aa] = importfile('raw_species_final.d',2, 1971);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/08/10 18:21:29
...
wh07_nname = rawCellColumns(:, 1);
wh07_zz = cell2mat(rawNumericColumns(:, 1));
wh07_aa = cell2mat(rawNumericColumns(:, 2));
